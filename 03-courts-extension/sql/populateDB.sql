...
BEGIN
    ...
    DELETE FROM courts;
	 ...
	 -- Pistas
	     INSERT INTO courts (court_id, name, surface, capacity) VALUES
        (1, 'No. 1 Court', 'Hierba', 12500),
        (2, 'Philippe-Chatrier', 'Arcilla', 14840),
        (3, 'Rod Laver Arena', 'Dura', 15000),
        (4, 'OtraPista4', 'Arcilla', 10000),
        (5, 'OtraPista5', 'Dura', 12000);
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (1, 8, 1, 2, 2, 'Wimbledon 2024', '2024-07-14', 'Final', 230,1);
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (2, 7, 3, 4, 3, 'US Open 2024', '2024-09-06', 'Semifinal', 195,3);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (2, 3, 1, '6-4'),
        (2, 4, 2, '3-6'),
        (2, 3, 3, '7-5');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (3, 9, 5, 1, 1, 'Roland Garros 2024', '2024-06-04', 'Cuartos de final', 210,2);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (3, 1, 1, '7-5'),
        (3, 5, 2, '4-6'),
        (3, 1, 3, '6-3');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (4, 9, 2, 4, 2, 'Indian Wells 2024', '2024-03-17', 'Final', 125,4);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (4, 2, 1, '7-5'),
        (4, 2, 2, '6-2');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (5, 7, 1, 3, 1, 'Australian Open 2024', '2024-01-28', 'Final', 180,3);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (5, 1, 1, '6-4'),
        (5, 3, 2, '3-6'),
        (5, 1, 3, '6-3');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (6, 8, 2, 5, 2, 'Mutua Madrid Open 2024', '2024-05-03', 'Semifinal', 140,3);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (6, 2, 1, '6-2'),
        (6, 2, 2, '6-4');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (7, 9, 4, 1, 4, 'ATP Finals 2024', '2024-11-12', 'Grupo', 115,5);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (7, 4, 1, '7-6'),
        (7, 4, 2, '6-3');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (8, 9, 3, 5, 3, 'Monte-Carlo 2024', '2024-04-12', 'Cuartos de final', 150,2);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (8, 3, 1, '6-3'),
        (8, 5, 2, '4-6'),
        (8, 3, 3, '6-4');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (9, 15, 2, 3, 2, 'Roland Garros 2025', '2025-06-08', 'Final', 205,2);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (9, 3, 1, '6-4'),
        (9, 2, 2, '7-5'),
        (9, 2, 3, '6-0'),
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (10, 16, 1, 2, 1, 'Wimbledon 2025', '2025-07-14', 'Final', 240,1);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (10, 1, 1, '6-4'),
        (10, 2, 2, '4-6'),
        (10, 1, 3, '7-6'),
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (11, 17, 10, 12, 12, 'Wimbledon 2025', '2025-07-08', 'Cuartos de final', 180,1);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (11, 12, 1, '6-4'),
        (11, 10, 2, '4-6'),
        (11, 12, 3, '6-3'),
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (12, 16, 10, 13, 10, 'Queens Club 2025', '2025-06-15', 'R32', 95,5);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (12, 10, 1, '7-6'),
        (12, 10, 2, '6-4');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (13, 16, 12, 14, 14, 'Queens Club 2025', '2025-06-15', 'R16', 88,5);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (13, 14, 1, '6-4'),
        (13, 14, 2, '6-3');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (14, 16, 1, 10, 10, 'Queens Club 2025', '2025-06-15', 'Cuartos de final', 105,5);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (14, 1, 1, '6-2'),
        (14, 10, 2, '6-4'),
        (14, 10, 3, '6-4');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (15, 18, 5, 10, 5, 'Rio Open 2025', '2025-02-25', 'Final', 175,4);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (15, 5, 1, '6-3'),
        (15, 10, 2, '4-6'),
        (15, 5, 3, '6-4');
    ...
    INSERT INTO matches (match_id, referee_id, player1_id, player2_id, winner_id, tournament, match_date, round, duration, court_id)
        VALUES (16, 17, 14, 13, 14, 'Laver Cup 2025', '2025-09-25', 'Exhibición', 120,2);
    INSERT INTO sets (match_id, winner_id, set_order, score) VALUES
        (16, 14, 1, '6-4'),
        (16, 14, 2, '7-5');
END //
